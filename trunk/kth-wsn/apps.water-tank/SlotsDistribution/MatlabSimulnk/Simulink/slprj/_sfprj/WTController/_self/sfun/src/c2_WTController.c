...
#include "WTController_sfun_debug_macros.h"
...
static const char *c2_debug_family_names[14] = { "UPDATE_INTERVAL", "NUMBER_WT",
  "WT_CALIBRATION", "WT_LIMIT", "wtId", "i", "nargin", "nargout", "y",
  "instantU", "u", "y_l1", "y_l2", "currentFrame" };

/* Function Declarations */
static void initialize_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance);
static void initialize_params_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance);
static void enable_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance);
static void disable_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_WTController
  (SFc2_WTControllerInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_WTController
  (SFc2_WTControllerInstanceStruct *chartInstance);
static void set_sim_state_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance, const mxArray *c2_st);
static void finalize_c2_WTController(SFc2_WTControllerInstanceStruct
  *chartInstance);
static void sf_c2_WTController(SFc2_WTControllerInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static real_T c2_mod(SFc2_WTControllerInstanceStruct *chartInstance, real_T c2_x,
                     real_T c2_y);
static void c2_eml_scalar_eg(SFc2_WTControllerInstanceStruct *chartInstance);
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[41]);
static const mxArray *c2_h_sf_marshall(void *chartInstanceVoid, void *c2_b_u);
static void c2_emlrt_marshallIn(SFc2_WTControllerInstanceStruct *chartInstance,
  const mxArray *c2_instantU, const char_T *c2_name, uint16_T c2_y[10]);
static real_T c2_b_emlrt_marshallIn(SFc2_WTControllerInstanceStruct
  *chartInstance, const mxArray *c2_b_currentFrame, const char_T *c2_name);
static void c2_c_emlrt_marshallIn(SFc2_WTControllerInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const char_T *c2_name, real_T c2_y[200]);
static void c2_d_emlrt_marshallIn(SFc2_WTControllerInstanceStruct *chartInstance,
  const mxArray *c2_b_y_l1, const char_T *c2_name, real_T c2_y[200]);
static void c2_e_emlrt_marshallIn(SFc2_WTControllerInstanceStruct *chartInstance,
  const mxArray *c2_b_y_l2, const char_T *c2_name, real_T c2_y[200]);
static uint8_T c2_f_emlrt_marshallIn(SFc2_WTControllerInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_WTController, const char_T
  *c2_name);
static void init_dsm_address_info(SFc2_WTControllerInstanceStruct *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_WTController = 0U;
}
  ...
  (SFc2_WTControllerInstanceStruct *chartInstance)
{
  ...
  c2_f_hoistedGlobal = chartInstance->c2_is_active_c2_WTController;
  ...
  *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_WTController = c2_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_b_u, 5)),
     "is_active_c2_WTController");
  sf_mex_destroy(&c2_b_u);
  c2_update_debugger_state_c2_WTController(chartInstance);
...
static void sf_c2_WTController(SFc2_WTControllerInstanceStruct *chartInstance)
{
  ...
  static const char *c2_sv0[14] = { "UPDATE_INTERVAL", "NUMBER_WT",
    "WT_CALIBRATION", "WT_LIMIT", "wtId", "i", "nargin", "nargout",
    "y", "instantU", "u", "y_l1", "y_l2", "currentFrame" };

  real_T c2_UPDATE_INTERVAL;
  real_T c2_NUMBER_WT;
  real_T c2_WT_CALIBRATION;
  real_T c2_WT_LIMIT;
  real_T c2_wtId;
  real_T c2_i;
  ...
  sf_debug_symbol_scope_add_eml(&c2_WT_CALIBRATION, c2_g_sf_marshall, 2U);
  sf_debug_symbol_scope_add_eml(&c2_WT_LIMIT, c2_g_sf_marshall, 3U);
  sf_debug_symbol_scope_add_eml(&c2_wtId, c2_g_sf_marshall, 4U);
  sf_debug_symbol_scope_add_eml(&c2_i, c2_g_sf_marshall, 5U);
  sf_debug_symbol_scope_add_eml(&c2_nargin, c2_g_sf_marshall, 6U);
  sf_debug_symbol_scope_add_eml(&c2_nargout, c2_g_sf_marshall, 7U);
  sf_debug_symbol_scope_add_eml(&c2_y, c2_f_sf_marshall, 8U);
  sf_debug_symbol_scope_add_eml(&c2_instantU, c2_e_sf_marshall, 9U);
  sf_debug_symbol_scope_add_eml(&chartInstance->c2_u, c2_d_sf_marshall, 10U);
  sf_debug_symbol_scope_add_eml(&chartInstance->c2_y_l1, c2_c_sf_marshall, 11U);
  sf_debug_symbol_scope_add_eml(&chartInstance->c2_y_l2, c2_b_sf_marshall, 12U);
  ...
  /*  check app_sensors_nbe.h */
  _SFD_EML_CALL(0,4);
  c2_NUMBER_WT = 10.0;

  /*  check app_sensors_nbe.h */
  _SFD_EML_CALL(0,5);
  c2_WT_CALIBRATION = 8.73932E+01;

  /*  check app_wt_calibration.h */
  _SFD_EML_CALL(0,6);
  c2_WT_LIMIT = 5.0;
  _SFD_EML_CALL(0,9);
  if (CV_EML_IF(0, 0, !chartInstance->c2_u_not_empty)) {
    ...
    for (c2_i18 = 0; c2_i18 < 200; c2_i18 = c2_i18 + 1) {
      chartInstance->c2_u[c2_i18] = 2048.0;
    }
  ...
  while (c2_b_i <= 20.0) {
    ...
    if (CV_EML_IF(0, 1, c2_i <= c2_NUMBER_WT)) {
      _SFD_EML_CALL(0,27);
      c2_b_hoistedGlobal = chartInstance->c2_currentFrame;
      c2_a = c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK(
        "i", c2_i), 1, 20, 1, 0) - 1];
      c2_d0 = (real_T)c2_a * 8.73932E+01;
      c2_d1 = c2_d0;
      ...
      chartInstance->c2_y_l1[(_SFD_EML_ARRAY_BOUNDS_CHECK("y_l1", (int32_T)
        _SFD_INTEGER_CHECK("currentFrame", c2_b_hoistedGlobal), 1, 20,
        1, 0) - 1) + 20 * (_SFD_EML_ARRAY_BOUNDS_CHECK("y_l1", (int32_T)
        _SFD_INTEGER_CHECK("wtId", c2_wtId), 1, 10, 2, 0) - 1)] = (real_T)
        c2_b_y;
    } else {
      _SFD_EML_CALL(0,29);
      c2_c_hoistedGlobal = chartInstance->c2_currentFrame;
      c2_b_a = c2_y[_SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK
        ("i", c2_i), 1, 20, 1, 0) - 1];
      c2_d3 = (real_T)c2_b_a * 8.73932E+01;
      c2_d4 = c2_d3;
      c2_d4 = c2_d4 < 0.0 ? muDoubleScalarCeil(c2_d4 - 0.5) :
        muDoubleScalarFloor(c2_d4 + 0.5);
      c2_d5 = c2_d4;
      if (c2_d5 < 65536.0) {
        if (c2_d5 >= 0.0) {
          c2_u1 = (uint16_T)c2_d5;
        } else {
          c2_u1 = 0U;
        }
      } else if (c2_d5 >= 65536.0) {
        c2_u1 = MAX_uint16_T;
      } else {
        c2_u1 = 0U;
      }
      ...
      chartInstance->c2_y_l2[(_SFD_EML_ARRAY_BOUNDS_CHECK("y_l2", (int32_T)
        _SFD_INTEGER_CHECK("currentFrame", c2_c_hoistedGlobal), 1, 20,
        1, 0) - 1) + 20 * (_SFD_EML_ARRAY_BOUNDS_CHECK("y_l2", (int32_T)
        _SFD_INTEGER_CHECK("wtId", c2_wtId), 1, 10, 2, 0) - 1)] = (real_T)
        c2_c_y;
    }
  ...
  /*  for i=1:size(y_l1,2) */
  /*      if y_l1(currentFrame,i) > WT_LIMIT || y_l2(currentFrame,i) > WT_LIMIT */
  /*          u(currentFrame, :) = 0; */
  /*      end */
  /*  end */
  _SFD_EML_CALL(0,51);
  c2_i19 = _SFD_EML_ARRAY_BOUNDS_CHECK("u", (int32_T)_SFD_INTEGER_CHECK(
    "currentFrame", chartInstance->c2_currentFrame), 1, 20, 1, 0)
    - 1;
  for (c2_i20 = 0; c2_i20 < 10; c2_i20 = c2_i20 + 1) {
    c2_d6 = chartInstance->c2_u[c2_i19 + 20 * c2_i20];
    c2_d7 = c2_d6;
    c2_d7 = c2_d7 < 0.0 ? muDoubleScalarCeil(c2_d7 - 0.5) : muDoubleScalarFloor
      (c2_d7 + 0.5);
    c2_d8 = c2_d7;
    if (c2_d8 < 65536.0) {
      if (c2_d8 >= 0.0) {
        c2_u2 = (uint16_T)c2_d8;
      } else {
        c2_u2 = 0U;
      }
    } else if (c2_d8 >= 65536.0) {
      c2_u2 = MAX_uint16_T;
    } else {
      c2_u2 = 0U;
    }

    c2_instantU[c2_i20] = c2_u2;
  }
  ...
  for (c2_i21 = 0; c2_i21 < 10; c2_i21 = c2_i21 + 1) {
    (*c2_b_instantU)[c2_i21] = c2_instantU[c2_i21];
  }

  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,0);
  _sfEvent_ = c2_previousEvent;
  sf_debug_check_for_state_inconsistency(_WTControllerMachineNumber_,
...
static const mxArray *c2_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  const mxArray *c2_b_y = NULL;
  SFc2_WTControllerInstanceStruct *chartInstance;
  chartInstance = (SFc2_WTControllerInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
...
static const mxArray *c2_b_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  for (c2_i23 = 0; c2_i23 < 10; c2_i23 = c2_i23 + 1) {
    for (c2_i24 = 0; c2_i24 < 20; c2_i24 = c2_i24 + 1) {
      c2_c_u[c2_i24 + c2_i22] = (*((real_T (*)[200])c2_b_u))[c2_i24 + c2_i22];
    }
...
static const mxArray *c2_c_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  for (c2_i26 = 0; c2_i26 < 10; c2_i26 = c2_i26 + 1) {
    for (c2_i27 = 0; c2_i27 < 20; c2_i27 = c2_i27 + 1) {
      c2_c_u[c2_i27 + c2_i25] = (*((real_T (*)[200])c2_b_u))[c2_i27 + c2_i25];
    }
...
static const mxArray *c2_d_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  for (c2_i29 = 0; c2_i29 < 10; c2_i29 = c2_i29 + 1) {
    for (c2_i30 = 0; c2_i30 < 20; c2_i30 = c2_i30 + 1) {
      c2_c_u[c2_i30 + c2_i28] = (*((real_T (*)[200])c2_b_u))[c2_i30 + c2_i28];
    }
...
static const mxArray *c2_e_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  for (c2_i31 = 0; c2_i31 < 10; c2_i31 = c2_i31 + 1) {
    c2_c_u[c2_i31] = (*((uint16_T (*)[10])c2_b_u))[c2_i31];
  }
...
static const mxArray *c2_f_sf_marshall(void *chartInstanceVoid, void *c2_b_u)
{
  ...
  chartInstance = (SFc2_WTControllerInstanceStruct *)chartInstanceVoid;
  c2_y = NULL;
  for (c2_i32 = 0; c2_i32 < 20; c2_i32 = c2_i32 + 1) {
    c2_c_u[c2_i32] = (*((uint16_T (*)[20])c2_b_u))[c2_i32];
  }
...
const mxArray *sf_c2_WTController_get_eml_resolved_functions_info(void)
{
  const mxArray *c2_nameCaptureInfo = NULL;
  c2_ResolvedFunctionInfo c2_info[41];
  const mxArray *c2_m0 = NULL;
  int32_T c2_i33;
  c2_ResolvedFunctionInfo *c2_r0;
  c2_nameCaptureInfo = NULL;
  c2_info_helper(c2_info);
  sf_mex_assign(&c2_m0, sf_mex_createstruct("nameCaptureInfo", 1, 41));
  for (c2_i33 = 0; c2_i33 < 41; c2_i33 = c2_i33 + 1) {
    ...
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", c2_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c2_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c2_i33);
    ...
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c2_i33
                    );
    sf_mex_addfield(c2_m0, sf_mex_create("nameCaptureInfo", &c2_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c2_i33
                    );
  }
...
static void c2_info_helper(c2_ResolvedFunctionInfo c2_info[41])
{
  ...
  c2_info[15].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[15].fileLength = 3425U;
  c2_info[15].fileTime1 = 1250672766U;
  c2_info[15].fileTime2 = 0U;
  c2_info[16].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c2_info[16].name = "strcmp";
  c2_info[16].dominantType = "char";
  c2_info[16].resolved = "[B]strcmp";
  ...
  c2_info[21].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m";
  c2_info[21].fileLength = 960U;
  c2_info[21].fileTime1 = 1228093788U;
  ...
  c2_info[28].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m";
  c2_info[28].name = "eml_scalar_mod";
  c2_info[28].dominantType = "double";
  c2_info[28].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_mod.m";
  c2_info[28].fileLength = 1103U;
  c2_info[28].fileTime1 = 1228093784U;
  ...
  c2_info[36].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/eml_scalar_abs.m";
  c2_info[36].name = "islogical";
  c2_info[36].dominantType = "double";
  c2_info[36].resolved = "[B]islogical";
  ...
  c2_info[37].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[37].fileLength = 1331U;
  c2_info[37].fileTime1 = 1246283386U;
  c2_info[37].fileTime2 = 0U;
  c2_info[38].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[38].name = "eml_is_float_class";
  c2_info[38].dominantType = "char";
  c2_info[38].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c2_info[38].fileLength = 226U;
  c2_info[38].fileTime1 = 1197850440U;
  c2_info[38].fileTime2 = 0U;
  c2_info[39].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c2_info[39].name = "uminus";
  c2_info[39].dominantType = "double";
  c2_info[39].resolved = "[B]uminus";
  c2_info[39].fileLength = 0U;
  c2_info[39].fileTime1 = 0U;
  c2_info[39].fileTime2 = 0U;
  c2_info[40].context = "";
  c2_info[40].name = "uint16";
  c2_info[40].dominantType = "double";
  c2_info[40].resolved = "[B]uint16";
...
static real_T c2_b_emlrt_marshallIn(SFc2_WTControllerInstanceStruct
  *chartInstance, const mxArray *c2_b_currentFrame, const char_T *
  c2_name)
{
  real_T c2_y;
  real_T c2_d9;
  if (mxIsEmpty(c2_b_currentFrame)) {
    ...
    chartInstance->c2_currentFrame_not_empty = TRUE;
    sf_mex_import(c2_name, sf_mex_dup(c2_b_currentFrame), &c2_d9, 1, 0, 0U, 0,
                  0U, 0);
    c2_y = c2_d9;
  }
...
static void c2_c_emlrt_marshallIn(SFc2_WTControllerInstanceStruct *chartInstance,
  const mxArray *c2_b_u, const char_T *c2_name,
  real_T c2_y[200])
{
  real_T c2_dv3[200];
  int32_T c2_i35;
  if (mxIsEmpty(c2_b_u)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_u), &c2_dv3, 1, 0, 0U, 1, 0U, 2, 20,
                  10);
    for (c2_i35 = 0; c2_i35 < 200; c2_i35 = c2_i35 + 1) {
  ...
  real_T c2_y[200])
{
  ...
  if (mxIsEmpty(c2_b_y_l1)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_y_l1), &c2_dv4, 1, 0, 0U, 1, 0U, 2,
                  20, 10);
    for (c2_i36 = 0; c2_i36 < 200; c2_i36 = c2_i36 + 1) {
      c2_y[c2_i36] = c2_dv4[c2_i36];
    }
  }
  ...
  real_T c2_y[200])
{
  ...
  if (mxIsEmpty(c2_b_y_l2)) {
    ...
    sf_mex_import(c2_name, sf_mex_dup(c2_b_y_l2), &c2_dv5, 1, 0, 0U, 1, 0U, 2,
                  20, 10);
    for (c2_i37 = 0; c2_i37 < 200; c2_i37 = c2_i37 + 1) {
      c2_y[c2_i37] = c2_dv5[c2_i37];
    }
  }
...
static uint8_T c2_f_emlrt_marshallIn(SFc2_WTControllerInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_WTController,
  const char_T *c2_name)
{
  uint8_T c2_y;
  uint8_T c2_u3;
  sf_mex_import(c2_name, sf_mex_dup(c2_b_is_active_c2_WTController), &c2_u3, 1,
                3, 0U, 0, 0U, 0);
  c2_y = c2_u3;
  sf_mex_destroy(&c2_b_is_active_c2_WTController);
  return c2_y;
}
...
/* SFunction Glue Code */
void sf_c2_WTController_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2292322693U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2515099031U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1723369605U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3351719663U);
}

mxArray *sf_c2_WTController_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1699132813U);
    pr[1] = (double)(3925469629U);
    pr[2] = (double)(1750218852U);
    pr[3] = (double)(3892485055U);
...
static mxArray *sf_get_sim_state_info_c2_WTController(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[4],T\"instantU\",},{M[4],M[0],T\"currentFrame\",S'l','i','p'{{M1x2[234 246],M[0],}}},{M[4],M[0],T\"u\",S'l','i','p'{{M1x2[232 233],M[0],}}},{M[4],M[0],T\"y_l1\",S'l','i','p'{{M1x2[222 226],M[0],}}},{M[4],M[0],T\"y_l2\",S'l','i','p'{{M1x2[227 231],M[0],}}},{M[8],M[0],T\"is_active_c2_WTController\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_WTController_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_WTControllerInstanceStruct *chartInstance;
    chartInstance = (SFc2_WTControllerInstanceStruct *) ((ChartInfoStruct *)
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_WTControllerMachineNumber_,
            chartInstance->chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_WTControllerMachineNumber_,chartInstance->chartNumber,1);
          sf_debug_set_chart_event_thresholds(_WTControllerMachineNumber_,
            chartInstance->chartNumber,
            0,
            0,
            0);
        ...
        _SFD_CV_INIT_EML(0,1,5,0,0,1,0,0,0);
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1368);
        _SFD_CV_INIT_EML_IF(0,0,249,262,-1,543);
        _SFD_CV_INIT_EML_IF(0,1,714,731,791,858);
        _SFD_CV_INIT_EML_IF(0,2,899,911,-1,937);
        _SFD_CV_INIT_EML_IF(0,3,988,1025,-1,1050);
        _SFD_CV_INIT_EML_IF(0,4,1321,1341,-1,1367);
        _SFD_CV_INIT_EML_FOR(0,0,689,707,941);
      ...
      sf_debug_reset_current_state_configuration(_WTControllerMachineNumber_,
        chartInstance->chartNumber,chartInstance->instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_WTController(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_WTControllerInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_WTController((SFc2_WTControllerInstanceStruct*)
    chartInstanceVar);
  initialize_c2_WTController((SFc2_WTControllerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c2_WTController(void *chartInstanceVar)
{
  enable_c2_WTController((SFc2_WTControllerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c2_WTController(void *chartInstanceVar)
{
  disable_c2_WTController((SFc2_WTControllerInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c2_WTController(void *chartInstanceVar)
{
  sf_c2_WTController((SFc2_WTControllerInstanceStruct*) chartInstanceVar);
}

static mxArray* sf_internal_get_sim_state_c2_WTController(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_WTController
    ((SFc2_WTControllerInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = sf_get_sim_state_info_c2_WTController();/* state var info */
...
static void sf_internal_set_sim_state_c2_WTController(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_WTController();/* state var info */
  mxError = sf_mex_call_matlab(1, plhs, 4, prhs, "sfprivate");
  mxDestroyArray(prhs[0]);
  mxDestroyArray(prhs[1]);
  mxDestroyArray(prhs[2]);
  ...
  set_sim_state_c2_WTController((SFc2_WTControllerInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static mxArray* sf_opaque_get_sim_state_c2_WTController(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_WTController(S);
}

static void sf_opaque_set_sim_state_c2_WTController(SimStruct* S, const mxArray *
  st)
{
  sf_internal_set_sim_state_c2_WTController(S, st);
}

static void sf_opaque_terminate_c2_WTController(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_WTControllerInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c2_WTController((SFc2_WTControllerInstanceStruct*) chartInstanceVar);
...
static void mdlProcessParameters_c2_WTController(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_WTController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("WTController","WTController",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("WTController","WTController",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("WTController",
      "WTController",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"WTController","WTController",2,1);
      sf_mark_chart_reusable_outputs(S,"WTController","WTController",2,1);
    }

    sf_set_rtw_dwork_info(S,"WTController","WTController",2);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(58173785U));
  ssSetChecksum1(S,(1787504260U));
  ssSetChecksum2(S,(2471169812U));
  ssSetChecksum3(S,(2317309442U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_WTController(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "WTController", "WTController",2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_WTController(SimStruct *S)
{
  SFc2_WTControllerInstanceStruct *chartInstance;
  chartInstance = (SFc2_WTControllerInstanceStruct *)malloc(sizeof
    (SFc2_WTControllerInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_WTControllerInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c2_WTController;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_WTController;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c2_WTController;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_WTController;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_WTController;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c2_WTController;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c2_WTController;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_WTController;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_WTController;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_WTController;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c2_WTController;
...
void c2_WTController_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_WTController(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_WTController(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_WTController(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_WTController_method_dispatcher.\n"
