...
enum {
	...
	NUMBER_WT_ET = number_et_water_tanks,
	NUMBER_WT_ST = number_water_tanks,
	NUMBER_WT = NUMBER_WT_ET + NUMBER_WT_ST,

	GTS_SLOTS_ALLOCATED = 10,

	EXTRA_SENSORS = number_sensors,
	NUMBER_TANKS = 2,

	WT_INITIAL_REFERENCE_TIME = 120000, // 80 s
	UART_QUEUE_LEN = 12,

	RADIO_CHANNEL = channel_to_use,
	PAN_ID = pan_id_to_use,
...
typedef struct InitConfigureController {
	nx_float Ad[NUMBER_WT][4];
	nx_float BdK[NUMBER_WT][4];
	nx_float BdV[NUMBER_WT][4];
	nx_float As[NUMBER_WT][4];
...
void initController(InitConfigureController* ctlr) {
	...
	ctlr->Ad[0][0] = 0.964855;
	ctlr->Ad[0][1] = 0.000000;
	ctlr->Ad[0][2] = 0.034532;
	ctlr->Ad[0][3] = 0.965532;

	ctlr->BdK[0][0] = -0.056922;
	ctlr->BdK[0][1] = -0.137480;
	ctlr->BdK[0][2] = -0.001012;
	ctlr->BdK[0][3] = -0.002445;

	ctlr->BdV[0][0] = 0.113849;
	ctlr->BdV[0][1] = 0.116125;
	ctlr->BdV[0][2] = 0.002025;
	ctlr->BdV[0][3] = 0.002065;

	ctlr->As[0][0] = 0.935335;
	ctlr->As[0][1] = -0.093618;
	ctlr->As[0][2] = 0.023932;
	ctlr->As[0][3] = 0.974565;
//	ctlr->As[1][0] = 0.999130;
//	ctlr->As[1][1] = -0.001864;
//	ctlr->As[1][2] = 0.000250;
//	ctlr->As[1][3] = 0.999582;
//	ctlr->As[2][0] = 0.999117;
//	ctlr->As[2][1] = -0.001510;
//	ctlr->As[2][2] = 0.000312;
//	ctlr->As[2][3] = 0.999595;
