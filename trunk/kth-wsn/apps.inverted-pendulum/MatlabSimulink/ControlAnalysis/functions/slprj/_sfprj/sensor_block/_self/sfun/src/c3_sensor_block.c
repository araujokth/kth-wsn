...
static const mxArray *get_sim_state_c3_sensor_block(void)
{
  ...
  real_T *c3_actuator_update;
  real_T *c3_actuator_value;
  real_T *c3_theta_delay;
  real_T *c3_theta_update;
  real_T *c3_theta_value;
  real_T *c3_xc_delay;
  real_T *c3_xc_update;
  real_T *c3_xc_value;
  c3_actuator_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 7);
  ...
  c3_xc_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  ...
  c3_theta_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  c3_st = NULL;
  c3_y = NULL;
...
static void set_sim_state_c3_sensor_block(const mxArray *c3_st)
{
  ...
  real_T c3_d5;
  real_T c3_f_y;
  const mxArray *c3_g_actuator_delay;
  real_T c3_d6;
  real_T c3_g_y;
  const mxArray *c3_h_actuator_delay;
  real_T c3_d7;
  real_T c3_h_y;
  const mxArray *c3_i_actuator_delay;
  real_T c3_d8;
  real_T c3_i_y;
  ...
  c3_xc_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c3_actuator_value = (real_T *)ssGetOutputPortSignal(chartInstance.S, 8);
  c3_j_actuator_delay = (real_T *)ssGetOutputPortSignal(chartInstance.S, 9);
  c3_theta_delay = (real_T *)ssGetOutputPortSignal(chartInstance.S, 6);
  c3_theta_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  ...
  *c3_j_actuator_delay = c3_y;
  c3_b_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 1));
  sf_mex_import("actuator_update", sf_mex_dup(c3_b_actuator_delay), &c3_d1, 1, 0,
                0U, 0, 0U, 0);
  c3_b_y = c3_d1;
  sf_mex_destroy(&c3_b_actuator_delay);
  *c3_actuator_update = c3_b_y;
  c3_c_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 2));
  sf_mex_import("actuator_value", sf_mex_dup(c3_c_actuator_delay), &c3_d2, 1, 0,
                0U, 0, 0U, 0);
  c3_c_y = c3_d2;
  sf_mex_destroy(&c3_c_actuator_delay);
  *c3_actuator_value = c3_c_y;
  c3_d_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 3));
  sf_mex_import("theta_delay", sf_mex_dup(c3_d_actuator_delay), &c3_d3, 1, 0, 0U,
                0, 0U, 0);
  c3_d_y = c3_d3;
  sf_mex_destroy(&c3_d_actuator_delay);
  *c3_theta_delay = c3_d_y;
  c3_e_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 4));
  sf_mex_import("theta_update", sf_mex_dup(c3_e_actuator_delay), &c3_d4, 1, 0,
                0U, 0, 0U, 0);
  c3_e_y = c3_d4;
  sf_mex_destroy(&c3_e_actuator_delay);
  *c3_theta_update = c3_e_y;
  c3_f_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 5));
  sf_mex_import("theta_value", sf_mex_dup(c3_f_actuator_delay), &c3_d5, 1, 0, 0U,
                0, 0U, 0);
  c3_f_y = c3_d5;
  sf_mex_destroy(&c3_f_actuator_delay);
  *c3_theta_value = c3_f_y;
  c3_g_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 6));
  sf_mex_import("xc_delay", sf_mex_dup(c3_g_actuator_delay), &c3_d6, 1, 0, 0U, 0,
                0U, 0);
  c3_g_y = c3_d6;
  sf_mex_destroy(&c3_g_actuator_delay);
  *c3_xc_delay = c3_g_y;
  c3_h_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 7));
  sf_mex_import("xc_update", sf_mex_dup(c3_h_actuator_delay), &c3_d7, 1, 0, 0U,
                0, 0U, 0);
  c3_h_y = c3_d7;
  sf_mex_destroy(&c3_h_actuator_delay);
  *c3_xc_update = c3_h_y;
  c3_i_actuator_delay = sf_mex_dup(sf_mex_getcell(c3_u, 8));
  sf_mex_import("xc_value", sf_mex_dup(c3_i_actuator_delay), &c3_d8, 1, 0, 0U, 0,
                0U, 0);
  c3_i_y = c3_d8;
  sf_mex_destroy(&c3_i_actuator_delay);
  *c3_xc_value = c3_i_y;
  ...
  if (mxIsEmpty(c3_b_actuator_delay_p)) {
    ...
    sf_mex_import("actuator_delay_p", sf_mex_dup(c3_b_actuator_delay_p), &c3_d9,
                  1, 0, 0U, 0, 0U, 0);
    c3_j_y = c3_d9;
  }
  ...
  if (mxIsEmpty(c3_b_actuator_value_p)) {
    ...
    sf_mex_import("actuator_value_p", sf_mex_dup(c3_b_actuator_value_p), &c3_d10,
                  1, 0, 0U, 0, 0U, 0);
    c3_k_y = c3_d10;
  }
  ...
  if (mxIsEmpty(c3_b_theta_delay_p)) {
    ...
    sf_mex_import("theta_delay_p", sf_mex_dup(c3_b_theta_delay_p), &c3_d11, 1, 0,
                  0U, 0, 0U, 0);
    c3_l_y = c3_d11;
  }
  ...
  if (mxIsEmpty(c3_b_theta_value_p)) {
    ...
    sf_mex_import("theta_value_p", sf_mex_dup(c3_b_theta_value_p), &c3_d12, 1, 0,
                  0U, 0, 0U, 0);
    c3_m_y = c3_d12;
  }
  ...
  if (mxIsEmpty(c3_b_xc_delay_p)) {
    ...
    sf_mex_import("xc_delay_p", sf_mex_dup(c3_b_xc_delay_p), &c3_d13, 1, 0, 0U,
                  0, 0U, 0);
    c3_n_y = c3_d13;
  }
  ...
  if (mxIsEmpty(c3_b_xc_value_p)) {
    ...
    sf_mex_import("xc_value_p", sf_mex_dup(c3_b_xc_value_p), &c3_d14, 1, 0, 0U,
                  0, 0U, 0);
    c3_o_y = c3_d14;
  }
...
static void sf_c3_sensor_block(void)
{
  ...
  _SFD_DATA_RANGE_CHECK(*c3_xc_update, 0U);
  ...
  _SFD_DATA_RANGE_CHECK(*c3_theta_update, 6U);
  _SFD_DATA_RANGE_CHECK(*c3_theta_value, 7U);
  _SFD_DATA_RANGE_CHECK(*c3_theta_delay, 8U);
  _SFD_DATA_RANGE_CHECK(*c3_actuator_update, 9U);
...
static void c3_c3_sensor_block(void)
{
  ...
  real_T *c3_b_actuator_update;
  real_T *c3_b_theta_delay;
  real_T *c3_b_theta_value;
  real_T *c3_b_theta_update;
  real_T *c3_b_xc_delay;
  real_T *c3_b_xc_value;
  real_T *c3_b_xc_update;
  uint16_T *c3_b_delay;
  uint16_T *c3_b_sensor_v;
  uint16_T *c3_b_src_addr;
  c3_b_actuator_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 7);
  ...
  c3_b_xc_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  ...
  c3_b_theta_update = (real_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  ...
  sf_debug_symbol_scope_add("actuator_delay_p",
    &chartInstance.c3_actuator_delay_p, c3_h_sf_marshall);
  sf_debug_symbol_scope_add("actuator_value_p",
    &chartInstance.c3_actuator_value_p, c3_g_sf_marshall);
  ...
  sf_debug_symbol_scope_add("NUMBER_SENSORS", &c3_NUMBER_SENSORS,
    c3_b_sf_marshall);
  sf_debug_symbol_scope_add("NUMBER_LINKS", &c3_NUMBER_LINKS, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("TIME_SYMBOL", &c3_TIME_SYMBOL, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("TPENDULUM_ADDRESS", &c3_TPENDULUM_ADDRESS,
    c3_b_sf_marshall);
  sf_debug_symbol_scope_add("XCART_ADDRESS", &c3_XCART_ADDRESS, c3_b_sf_marshall);
  ...
  sf_debug_symbol_scope_add("actuator_update", &c3_actuator_update,
    c3_b_sf_marshall);
  sf_debug_symbol_scope_add("theta_delay", &c3_theta_delay, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("theta_value", &c3_theta_value, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("theta_update", &c3_theta_update, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("xc_delay", &c3_xc_delay, c3_b_sf_marshall);
  sf_debug_symbol_scope_add("xc_value", &c3_xc_value, c3_b_sf_marshall);
...
const mxArray *sf_c3_sensor_block_get_eml_resolved_functions_info(void)
{
  ...
  for (c3_i0 = 0; c3_i0 < 22; c3_i0 = c3_i0 + 1) {
    c3_r0 = &c3_info[c3_i0];
...
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[22])
{
  ...
  c3_info[20].context = "";
  c3_info[20].name = "minus";
  c3_info[20].dominantType = "double";
  c3_info[20].resolved = "[B]minus";
  c3_info[20].fileLength = 0U;
  c3_info[20].fileTime1 = 0U;
  c3_info[20].fileTime2 = 0U;
  c3_info[21].context = "";
  c3_info[21].name = "le";
  c3_info[21].dominantType = "uint16";
  c3_info[21].resolved = "[B]le";
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3032589523U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1852225657U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2194799187U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3925794705U);
}
...
mxArray *sf_c3_sensor_block_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(963966628U);
    pr[1] = (double)(1429115964U);
    pr[2] = (double)(2974412169U);
    pr[3] = (double)(1431310076U);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(2,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "xc_value",0,(MexFcnForType)c3_b_sf_marshall);
          _SFD_SET_DATA_PROPS(3,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "xc_delay",0,(MexFcnForType)c3_b_sf_marshall);
          ...
          _SFD_SET_DATA_PROPS(7,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "theta_value",0,(MexFcnForType)c3_b_sf_marshall);
          _SFD_SET_DATA_PROPS(8,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "theta_delay",0,(MexFcnForType)c3_b_sf_marshall);
          ...
          _SFD_SET_DATA_PROPS(10,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "actuator_value",0,(MexFcnForType)c3_b_sf_marshall);
          _SFD_SET_DATA_PROPS(11,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "actuator_delay",0,(MexFcnForType)c3_b_sf_marshall);
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,1865);
        _SFD_CV_INIT_EML_IF(0,0,501,523,-1,733);
        _SFD_CV_INIT_EML_IF(0,1,792,861,-1,1608);
        _SFD_CV_INIT_EML_IF(0,2,990,1018,1163,1600);
        _SFD_CV_INIT_EML_IF(0,3,1163,1199,1352,1600);
        _SFD_CV_INIT_EML_IF(0,4,1352,1390,-1,1390);

        {
          static int condStart[] = { 797, 849 };

          static int condEnd[] = { 844, 861 };

          static int pfixExpr[] = { 0, 1, -3 };

          _SFD_CV_INIT_EML_MCDC(0,0,797,861,2,0,&(condStart[0]),&(condEnd[0]),3,
                                &(pfixExpr[0]));
        }
...

        {
          ...
          real_T *c3_actuator_value;
          real_T *c3_actuator_delay;
          c3_actuator_update = (real_T *)ssGetOutputPortSignal(chartInstance.S,
            7);
          c3_src_addr = (uint16_T *)ssGetInputPortSignal(chartInstance.S, 0);
          c3_sensor_v = (uint16_T *)ssGetInputPortSignal(chartInstance.S, 1);
          c3_delay = (uint16_T *)ssGetInputPortSignal(chartInstance.S, 2);
...
static void mdlSetWorkWidths_c3_sensor_block(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(1853690623U));
  ssSetChecksum1(S,(2536689420U));
  ssSetChecksum2(S,(1652468022U));
  ssSetChecksum3(S,(269109540U));
