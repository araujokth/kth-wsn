...
static SFc6_sensor_block_pulseInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c6_sensor_block_pulse(void);
static void initialize_params_c6_sensor_block_pulse(void);
static void enable_c6_sensor_block_pulse(void);
static void disable_c6_sensor_block_pulse(void);
static void c6_update_debugger_state_c6_sensor_block_pulse(void);
static const mxArray *get_sim_state_c6_sensor_block_pulse(void);
static void set_sim_state_c6_sensor_block_pulse(const mxArray *c6_st);
static void finalize_c6_sensor_block_pulse(void);
static void sf_c6_sensor_block_pulse(void);
...
static void initialize_c6_sensor_block_pulse(void)
{
  ...
  chartInstance.c6_is_active_c6_sensor_block_pulse = 0U;
}
...
static const mxArray *get_sim_state_c6_sensor_block_pulse(void)
{
  ...
  c6_errors = (boolean_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  ...
  c6_b_u = *c6_errors;
  c6_c_y = NULL;
  sf_mex_assign(&c6_c_y, sf_mex_create("y", &c6_b_u, 11, 0U, 0U, 0U, 0));
  ...
  c6_f_u = chartInstance.c6_is_active_c6_sensor_block_pulse;
  c6_g_y = NULL;
...
static void set_sim_state_c6_sensor_block_pulse(const mxArray *c6_st)
{
  ...
  real_T c6_d2;
  real_T c6_e_y;
  const mxArray *c6_b_is_active_c6_sensor_block_pulse;
  uint8_T c6_u0;
  uint8_T c6_f_y;
  real_T *c6_c_delay;
  boolean_T *c6_b_errors;
  real_T *c6_reliability;
  c6_c_delay = (real_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  c6_b_errors = (boolean_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c6_reliability = (real_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  ...
  *c6_c_delay = c6_y;
  c6_errors = sf_mex_dup(sf_mex_getcell(c6_u, 1));
  sf_mex_import("errors", sf_mex_dup(c6_errors), &c6_b0, 1, 11, 0U, 0, 0U, 0);
  c6_b_y = c6_b0;
  sf_mex_destroy(&c6_errors);
  *c6_b_errors = c6_b_y;
  c6_b_delay = sf_mex_dup(sf_mex_getcell(c6_u, 2));
  sf_mex_import("reliability", sf_mex_dup(c6_b_delay), &c6_d1, 1, 0, 0U, 0, 0U,
                0);
  c6_c_y = c6_d1;
  ...
  *c6_reliability = c6_c_y;
  ...
  if (mxIsEmpty(c6_b_idx)) {
    ...
    sf_mex_import("idx", sf_mex_dup(c6_b_idx), &c6_d2, 1, 0, 0U, 0, 0U, 0);
    c6_e_y = c6_d2;
  }

  sf_mex_destroy(&c6_b_idx);
  chartInstance.c6_idx = c6_e_y;
  c6_b_is_active_c6_sensor_block_pulse = sf_mex_dup(sf_mex_getcell(c6_u, 5));
  sf_mex_import("is_active_c6_sensor_block_pulse", sf_mex_dup
                (c6_b_is_active_c6_sensor_block_pulse), &c6_u0, 1, 3, 0U, 0, 0U,
                0);
  c6_f_y = c6_u0;
  sf_mex_destroy(&c6_b_is_active_c6_sensor_block_pulse);
  chartInstance.c6_is_active_c6_sensor_block_pulse = c6_f_y;
  sf_mex_destroy(&c6_u);
  c6_update_debugger_state_c6_sensor_block_pulse();
...
static void sf_c6_sensor_block_pulse(void)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c6_b_errors, 3U);
  ...
  sf_debug_symbol_scope_add("idx", &chartInstance.c6_idx, c6_e_sf_marshall);
  ...
  sf_debug_symbol_scope_add("errors", &c6_errors, c6_c_sf_marshall);
  ...
  _SFD_EML_CALL(0,26);
  if (CV_EML_COND(0, 0, c6_xc_errors == 1.0)) {
  } else if (CV_EML_COND(0, 1, c6_theta_errors == 1.0)) {
  } else if (CV_EML_COND(0, 2, c6_actuator_errors == 1.0)) {
    goto label_1;
  } else {
 ...
 label_2:
  ...
  /* errors = (xc_errors + theta_errors + actuator_errors); */
  _SFD_EML_CALL(0,32);
  ...
  /* reliability = [ ; xc_reliability ; theta_reliability ; actuator_reliability]; */
  /* errors = [xc_errors ; theta_errors ; actuator_errors]; */
  _SFD_EML_CALL(0,35);
...
const mxArray *sf_c6_sensor_block_pulse_get_eml_resolved_functions_info(void)
{
...
static void c6_info_helper(c6_ResolvedFunctionInfo c6_info[35])
{
  ...
  c6_info[19].name = "ndims";
  c6_info[19].dominantType = "double";
  c6_info[19].resolved = "[B]ndims";
...
/* SFunction Glue Code */
void sf_c6_sensor_block_pulse_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1749209608U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3475915011U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(682739923U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(513239805U);
}

mxArray *sf_c6_sensor_block_pulse_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(429243663U);
    pr[1] = (double)(2646659905U);
    pr[2] = (double)(3681737615U);
    pr[3] = (double)(2526892128U);
...
static mxArray *sf_get_sim_state_info_c6_sensor_block_pulse(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x6'type','srcId','name','auxInfo'{{M[1],M[32],T\"delay\",},{M[1],M[10],T\"errors\",},{M[1],M[11],T\"reliability\",},{M[4],M[0],T\"checkLinks\",S'l','i','p'{{M1x2[269 279],M[0],}}},{M[4],M[0],T\"idx\",S'l','i','p'{{M1x2[280 283],M[0],}}},{M[8],M[0],T\"is_active_c6_sensor_block_pulse\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 6, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_sensor_block_pulse_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,2,0,1,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"errors",0,
        ...
        _SFD_CV_INIT_EML(0,1,4,0,1,0,3,1);
        ...
        _SFD_CV_INIT_EML_IF(0,3,546,610,630,658);
        _SFD_CV_INIT_EML_FOR(0,0,429,456,524);

        {
          static int condStart[] = { 550, 568, 589 };

          static int condEnd[] = { 564, 585, 609 };

          static int pfixExpr[] = { 0, 1, -2, 2, -2 };

          _SFD_CV_INIT_EML_MCDC(0,0,550,609,3,0,&(condStart[0]),&(condEnd[0]),5,
                                &(pfixExpr[0]));
        }
...
static void sf_opaque_initialize_c6_sensor_block_pulse(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c6_sensor_block_pulse();
  initialize_c6_sensor_block_pulse();
}

static void sf_opaque_enable_c6_sensor_block_pulse(void *chartInstanceVar)
{
  enable_c6_sensor_block_pulse();
}

static void sf_opaque_disable_c6_sensor_block_pulse(void *chartInstanceVar)
{
  disable_c6_sensor_block_pulse();
}

static void sf_opaque_gateway_c6_sensor_block_pulse(void *chartInstanceVar)
{
  sf_c6_sensor_block_pulse();
}

static mxArray* sf_opaque_get_sim_state_c6_sensor_block_pulse(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c6_sensor_block_pulse();
  return st;
}

static void sf_opaque_set_sim_state_c6_sensor_block_pulse(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c6_sensor_block_pulse(sf_mex_dup(st));
}

static void sf_opaque_terminate_c6_sensor_block_pulse(void *chartInstanceVar)
{
  ...
  finalize_c6_sensor_block_pulse();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_sensor_block_pulse(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_sensor_block_pulse(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("sensor_block_pulse","sensor_block_pulse",6);
    ...
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("sensor_block_pulse",
      "sensor_block_pulse",6,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"sensor_block_pulse",
        "sensor_block_pulse",6,10);
      sf_mark_chart_reusable_outputs(S,"sensor_block_pulse","sensor_block_pulse",
        6,3);
    }

    sf_set_rtw_dwork_info(S,"sensor_block_pulse","sensor_block_pulse",6);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(358406548U));
  ssSetChecksum1(S,(763212925U));
  ssSetChecksum2(S,(2704983690U));
  ssSetChecksum3(S,(2682314910U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c6_sensor_block_pulse(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "sensor_block_pulse", "sensor_block_pulse",6);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c6_sensor_block_pulse(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_sensor_block_pulse;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c6_sensor_block_pulse;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c6_sensor_block_pulse;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c6_sensor_block_pulse;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c6_sensor_block_pulse;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_sensor_block_pulse;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_sensor_block_pulse;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_sensor_block_pulse;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c6_sensor_block_pulse;
  chartInstance.chartInfo.mdlStart = mdlStart_c6_sensor_block_pulse;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_sensor_block_pulse;
...
void c6_sensor_block_pulse_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_sensor_block_pulse(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_sensor_block_pulse(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_sensor_block_pulse(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_sensor_block_pulse_method_dispatcher.\n"
