#ifndef __c3_sensor_block_pulse_h__
#define __c3_sensor_block_pulse_h__
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_sensor_block_pulse;
  ChartInfoStruct chartInfo;
} SFc3_sensor_block_pulseInstanceStruct;
...
extern const mxArray *sf_c3_sensor_block_pulse_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c3_sensor_block_pulse_get_check_sum(mxArray *plhs[]);
extern void c3_sensor_block_pulse_method_dispatcher(SimStruct *S, int_T method,
  void *data);
