#ifndef __c5_sensor_block_pulse_h__
#define __c5_sensor_block_pulse_h__
...
typedef struct {
  ...
  uint8_T c5_is_active_c5_sensor_block_pulse;
  ChartInfoStruct chartInfo;
} SFc5_sensor_block_pulseInstanceStruct;
...
extern const mxArray *sf_c5_sensor_block_pulse_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c5_sensor_block_pulse_get_check_sum(mxArray *plhs[]);
extern void c5_sensor_block_pulse_method_dispatcher(SimStruct *S, int_T method,
  void *data);
