...
#include "c1_sensor_block_together.h"
...
static SFc1_sensor_block_togetherInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c1_sensor_block_together(void);
static void initialize_params_c1_sensor_block_together(void);
static void enable_c1_sensor_block_together(void);
static void disable_c1_sensor_block_together(void);
static void c1_update_debugger_state_c1_sensor_block_together(void);
static const mxArray *get_sim_state_c1_sensor_block_together(void);
static void set_sim_state_c1_sensor_block_together(const mxArray *c1_st);
static void finalize_c1_sensor_block_together(void);
static void sf_c1_sensor_block_together(void);
...
static void initialize_c1_sensor_block_together(void)
{
  ...
  chartInstance.c1_is_active_c1_sensor_block_together = 0U;
}
...
static const mxArray *get_sim_state_c1_sensor_block_together(void)
{
  ...
  c1_h_u = chartInstance.c1_is_active_c1_sensor_block_together;
  c1_i_y = NULL;
...
static void set_sim_state_c1_sensor_block_together(const mxArray *c1_st)
{
  ...
  uint16_T c1_u1;
  uint16_T c1_g_y;
  const mxArray *c1_b_is_active_c1_sensor_block_together;
  uint8_T c1_u2;
  uint8_T c1_h_y;
  real_T *c1_c_errors;
  real_T *c1_reliability;
  ...
  *c1_reliability = c1_b_y;
  ...
  c1_b_is_active_c1_sensor_block_together = sf_mex_dup(sf_mex_getcell(c1_u, 7));
  sf_mex_import("is_active_c1_sensor_block_together", sf_mex_dup
                (c1_b_is_active_c1_sensor_block_together), &c1_u2, 1, 3, 0U, 0,
                0U, 0);
  c1_h_y = c1_u2;
  sf_mex_destroy(&c1_b_is_active_c1_sensor_block_together);
  chartInstance.c1_is_active_c1_sensor_block_together = c1_h_y;
  sf_mex_destroy(&c1_u);
  c1_update_debugger_state_c1_sensor_block_together();
...
const mxArray *sf_c1_sensor_block_together_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c1_sensor_block_together_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c1_sensor_block_together_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c1_sensor_block_together(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c1_sensor_block_together();
  initialize_c1_sensor_block_together();
}

static void sf_opaque_enable_c1_sensor_block_together(void *chartInstanceVar)
{
  enable_c1_sensor_block_together();
}

static void sf_opaque_disable_c1_sensor_block_together(void *chartInstanceVar)
{
  disable_c1_sensor_block_together();
}

static void sf_opaque_gateway_c1_sensor_block_together(void *chartInstanceVar)
{
  sf_c1_sensor_block_together();
}

static mxArray* sf_opaque_get_sim_state_c1_sensor_block_together(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c1_sensor_block_together();
  return st;
}

static void sf_opaque_set_sim_state_c1_sensor_block_together(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c1_sensor_block_together(sf_mex_dup(st));
}

static void sf_opaque_terminate_c1_sensor_block_together(void *chartInstanceVar)
{
  ...
  finalize_c1_sensor_block_together();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c1_sensor_block_together(SimStruct *S)
{
  int i;
...
static void mdlRTW_c1_sensor_block_together(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c1_sensor_block_together(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c1_sensor_block_together;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c1_sensor_block_together;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c1_sensor_block_together;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c1_sensor_block_together;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c1_sensor_block_together;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c1_sensor_block_together;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c1_sensor_block_together;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c1_sensor_block_together;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c1_sensor_block_together;
  chartInstance.chartInfo.mdlStart = mdlStart_c1_sensor_block_together;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c1_sensor_block_together;
...
void c1_sensor_block_together_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c1_sensor_block_together(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c1_sensor_block_together(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c1_sensor_block_together(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c1_sensor_block_together_method_dispatcher.\n"
