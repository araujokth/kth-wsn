#ifndef __c3_sensor_block_complete_h__
#define __c3_sensor_block_complete_h__
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_sensor_block_complete;
  ChartInfoStruct chartInfo;
} SFc3_sensor_block_completeInstanceStruct;
...
extern void c3_sensor_block_complete_method_dispatcher(SimStruct *S, int_T
  method, void *data);
