...
static const mxArray *get_sim_state_c5_sensor_block(void)
{
  ...
  c5_h_u = chartInstance.c5_is_active_c5_sensor_block;
  c5_i_y = NULL;
...
static void set_sim_state_c5_sensor_block(const mxArray *c5_st)
{
  ...
  *c5_reliability = c5_b_y;
  ...
  c5_b_is_active_c5_sensor_block = sf_mex_dup(sf_mex_getcell(c5_u, 7));
  sf_mex_import("is_active_c5_sensor_block", sf_mex_dup
                (c5_b_is_active_c5_sensor_block), &c5_u2, 1, 3, 0U, 0, 0U, 0);
  c5_h_y = c5_u2;
  sf_mex_destroy(&c5_b_is_active_c5_sensor_block);
  chartInstance.c5_is_active_c5_sensor_block = c5_h_y;
  sf_mex_destroy(&c5_u);
