#ifndef __c4_sensor_block_pulse_h__
#define __c4_sensor_block_pulse_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_sensor_block_pulse;
  ChartInfoStruct chartInfo;
} SFc4_sensor_block_pulseInstanceStruct;
...
extern const mxArray *sf_c4_sensor_block_pulse_get_eml_resolved_functions_info
  (void);

/* Function Definitions */
extern void sf_c4_sensor_block_pulse_get_check_sum(mxArray *plhs[]);
extern void c4_sensor_block_pulse_method_dispatcher(SimStruct *S, int_T method,
  void *data);
