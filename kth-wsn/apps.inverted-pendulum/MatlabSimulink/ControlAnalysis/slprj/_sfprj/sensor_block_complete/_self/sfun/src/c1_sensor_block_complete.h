#ifndef __c1_sensor_block_complete_h__
#define __c1_sensor_block_complete_h__
...
typedef struct {
  ...
  uint8_T c1_is_active_c1_sensor_block_complete;
  ChartInfoStruct chartInfo;
} SFc1_sensor_block_completeInstanceStruct;
...
extern void c1_sensor_block_complete_method_dispatcher(SimStruct *S, int_T
  method, void *data);
