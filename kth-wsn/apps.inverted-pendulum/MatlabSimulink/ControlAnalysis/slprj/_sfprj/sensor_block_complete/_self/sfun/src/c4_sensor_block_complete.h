#ifndef __c4_sensor_block_complete_h__
#define __c4_sensor_block_complete_h__
...
typedef struct {
  ...
  uint8_T c4_is_active_c4_sensor_block_complete;
  ChartInfoStruct chartInfo;
} SFc4_sensor_block_completeInstanceStruct;
...
extern void c4_sensor_block_complete_method_dispatcher(SimStruct *S, int_T
  method, void *data);
