...
static const mxArray *get_sim_state_c4_sensor_block(void)
{
  ...
  c4_h_u = chartInstance.c4_is_active_c4_sensor_block;
  c4_i_y = NULL;
...
static void set_sim_state_c4_sensor_block(const mxArray *c4_st)
{
  ...
  *c4_reliability = c4_b_y;
  ...
  c4_b_is_active_c4_sensor_block = sf_mex_dup(sf_mex_getcell(c4_u, 7));
  sf_mex_import("is_active_c4_sensor_block", sf_mex_dup
                (c4_b_is_active_c4_sensor_block), &c4_u2, 1, 3, 0U, 0, 0U, 0);
  c4_h_y = c4_u2;
  sf_mex_destroy(&c4_b_is_active_c4_sensor_block);
  chartInstance.c4_is_active_c4_sensor_block = c4_h_y;
  sf_mex_destroy(&c4_u);
