#ifndef __c3_sensor_block_h__
#define __c3_sensor_block_h__
...
typedef struct {
  ...
  uint8_T c3_is_active_c3_sensor_block;
  ChartInfoStruct chartInfo;
} SFc3_sensor_blockInstanceStruct;
...
extern const mxArray *sf_c3_sensor_block_get_eml_resolved_functions_info(void);

/* Function Definitions */
extern void sf_c3_sensor_block_get_check_sum(mxArray *plhs[]);
extern void c3_sensor_block_method_dispatcher(SimStruct *S, int_T method, void
  *data);
