...
#include "sensor_block_together_sfun.h"
#include "c2_sensor_block_together.h"
#include "mwmathutil.h"
#define CHARTINSTANCE_CHARTNUMBER      (chartInstance.chartNumber)
#define CHARTINSTANCE_INSTANCENUMBER   (chartInstance.instanceNumber)
#include "sensor_block_together_sfun_debug_macros.h"
...
static SFc2_sensor_block_togetherInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c2_sensor_block_together(void);
static void initialize_params_c2_sensor_block_together(void);
static void enable_c2_sensor_block_together(void);
static void disable_c2_sensor_block_together(void);
static void c2_update_debugger_state_c2_sensor_block_together(void);
static const mxArray *get_sim_state_c2_sensor_block_together(void);
static void set_sim_state_c2_sensor_block_together(const mxArray *c2_st);
static void finalize_c2_sensor_block_together(void);
static void sf_c2_sensor_block_together(void);
static void c2_c2_sensor_block_together(void);
...
static void initialize_c2_sensor_block_together(void)
{
  ...
  chartInstance.c2_is_active_c2_sensor_block_together = 0U;
}
...
static const mxArray *get_sim_state_c2_sensor_block_together(void)
{
  ...
  c2_delay = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  c2_pck_success = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 5);
  c2_pck_total = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 6);
  ...
  c2_g_u = chartInstance.c2_is_active_c2_sensor_block_together;
  c2_h_y = NULL;
...
static void set_sim_state_c2_sensor_block_together(const mxArray *c2_st)
{
  ...
  uint32_T c2_u5;
  uint32_T c2_f_y;
  const mxArray *c2_b_is_active_c2_sensor_block_together;
  uint8_T c2_u6;
  uint8_T c2_g_y;
  uint16_T *c2_f_delay;
  uint16_T *c2_pck_success;
  ...
  c2_f_delay = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  c2_pck_success = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 5);
  c2_pck_total = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 6);
  c2_sensor_v = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 3);
  c2_src_addr = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 2);
  ...
  *c2_b_timestamp = c2_f_y;
  c2_b_is_active_c2_sensor_block_together = sf_mex_dup(sf_mex_getcell(c2_u, 6));
  sf_mex_import("is_active_c2_sensor_block_together", sf_mex_dup
                (c2_b_is_active_c2_sensor_block_together), &c2_u6, 1, 3, 0U, 0,
                0U, 0);
  c2_g_y = c2_u6;
  sf_mex_destroy(&c2_b_is_active_c2_sensor_block_together);
  chartInstance.c2_is_active_c2_sensor_block_together = c2_g_y;
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_sensor_block_together();
...
static void sf_c2_sensor_block_together(void)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c2_delay, 4U);
  _SFD_DATA_RANGE_CHECK((real_T)*c2_pck_success, 5U);
  _SFD_DATA_RANGE_CHECK((real_T)*c2_pck_total, 6U);
  c2_previousEvent = _sfEvent_;
  _sfEvent_ = CALL_EVENT;
  c2_c2_sensor_block_together();
  _sfEvent_ = c2_previousEvent;
  sf_debug_check_for_state_inconsistency(_sensor_block_togetherMachineNumber_,
...
static void c2_c2_sensor_block_together(void)
{
  ...
  uint8_T (*c2_b_u)[26];
  c2_b_timestamp = (uint32_T *)ssGetOutputPortSignal(chartInstance.S, 1);
  c2_b_delay = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 4);
  c2_b_pck_success = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 5);
  c2_b_pck_total = (uint16_T *)ssGetOutputPortSignal(chartInstance.S, 6);
...
const mxArray *sf_c2_sensor_block_together_get_eml_resolved_functions_info(void)
{
...
/* SFunction Glue Code */
void sf_c2_sensor_block_together_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4235654346U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3271522799U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3239190999U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(498828328U);
}

mxArray *sf_c2_sensor_block_together_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(1639689416U);
    pr[1] = (double)(1961725551U);
    pr[2] = (double)(96506294U);
    pr[3] = (double)(1298464260U);
...
static mxArray *sf_get_sim_state_info_c2_sensor_block_together(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[8],T\"delay\",},{M[1],M[12],T\"pck_success\",},{M[1],M[14],T\"pck_total\",},{M[1],M[11],T\"sensor_v\",},{M[1],M[13],T\"src_addr\",},{M[1],M[5],T\"timestamp\",},{M[8],M[0],T\"is_active_c2_sensor_block_together\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_sensor_block_together_get_check_sum(&mxChecksum);
    ...
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        chartAlreadyPresent = sf_debug_initialize_chart
          (_sensor_block_togetherMachineNumber_,
           2,
           1,
           1,
           7,
        ...
        if (chartAlreadyPresent==0) {
          ...
          init_script_number_translation(_sensor_block_togetherMachineNumber_,
            chartInstance.chartNumber);
          sf_debug_set_chart_disable_implicit_casting
            (_sensor_block_togetherMachineNumber_,chartInstance.chartNumber,1);
          ...
          _SFD_SET_DATA_PROPS(4,2,0,1,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,"delay",0,
          ...
          _SFD_SET_DATA_PROPS(6,2,0,1,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,
        ...
        _SFD_CV_INIT_EML_FCN(0,0,"eML_blk_kernel",0,-1,2119);
...

        {
          ...
          _SFD_SET_DATA_VALUE_PTR(4U, c2_delay);
          _SFD_SET_DATA_VALUE_PTR(5U, c2_pck_success);
          _SFD_SET_DATA_VALUE_PTR(6U, c2_pck_total);
        }
      }
    } else {
      sf_debug_reset_current_state_configuration
        (_sensor_block_togetherMachineNumber_,chartInstance.chartNumber,
         chartInstance.instanceNumber);
    }
  }
}

static void sf_opaque_initialize_c2_sensor_block_together(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c2_sensor_block_together();
  initialize_c2_sensor_block_together();
}

static void sf_opaque_enable_c2_sensor_block_together(void *chartInstanceVar)
{
  enable_c2_sensor_block_together();
}

static void sf_opaque_disable_c2_sensor_block_together(void *chartInstanceVar)
{
  disable_c2_sensor_block_together();
}

static void sf_opaque_gateway_c2_sensor_block_together(void *chartInstanceVar)
{
  sf_c2_sensor_block_together();
}

static mxArray* sf_opaque_get_sim_state_c2_sensor_block_together(void
  *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c2_sensor_block_together();
  return st;
}

static void sf_opaque_set_sim_state_c2_sensor_block_together(void
  *chartInstanceVar, const mxArray *st)
{
  set_sim_state_c2_sensor_block_together(sf_mex_dup(st));
}

static void sf_opaque_terminate_c2_sensor_block_together(void *chartInstanceVar)
{
  ...
  finalize_c2_sensor_block_together();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_sensor_block_together(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_sensor_block_together(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("sensor_block_together",
      "sensor_block_together",2);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("sensor_block_together",
                "sensor_block_together",2,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("sensor_block_together",
      "sensor_block_together",2,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"sensor_block_together",
        "sensor_block_together",2,1);
      sf_mark_chart_reusable_outputs(S,"sensor_block_together",
        "sensor_block_together",2,6);
    }

    sf_set_rtw_dwork_info(S,"sensor_block_together","sensor_block_together",2);
    ssSetHasSubFunctions(S,!(chartIsInlinable));
    ssSetOptions(S,ssGetOptions(S)|SS_OPTION_WORKS_WITH_CODE_REUSE);
  }

  ssSetChecksum0(S,(2521516549U));
  ssSetChecksum1(S,(4139797039U));
  ssSetChecksum2(S,(801299171U));
  ssSetChecksum3(S,(821205989U));
  ssSetmdlDerivatives(S, NULL);
  ssSetExplicitFCSSCtrl(S,1);
}

static void mdlRTW_c2_sensor_block_together(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "sensor_block_together", "sensor_block_together",
      2);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c2_sensor_block_together(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_sensor_block_together;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c2_sensor_block_together;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c2_sensor_block_together;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c2_sensor_block_together;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c2_sensor_block_together;
  chartInstance.chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_sensor_block_together;
  chartInstance.chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_sensor_block_together;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_sensor_block_together;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c2_sensor_block_together;
  chartInstance.chartInfo.mdlStart = mdlStart_c2_sensor_block_together;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_sensor_block_together;
...
void c2_sensor_block_together_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_sensor_block_together(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_sensor_block_together(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_sensor_block_together(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_sensor_block_together_method_dispatcher.\n"
