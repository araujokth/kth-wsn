...
static const mxArray *get_sim_state_c2_sensor_block(void)
{
  ...
  c2_g_u = chartInstance.c2_is_active_c2_sensor_block;
  c2_h_y = NULL;
...
static void set_sim_state_c2_sensor_block(const mxArray *c2_st)
{
  ...
  *c2_b_timestamp = c2_f_y;
  c2_b_is_active_c2_sensor_block = sf_mex_dup(sf_mex_getcell(c2_u, 6));
  sf_mex_import("is_active_c2_sensor_block", sf_mex_dup
                (c2_b_is_active_c2_sensor_block), &c2_u6, 1, 3, 0U, 0, 0U, 0);
  c2_g_y = c2_u6;
  sf_mex_destroy(&c2_b_is_active_c2_sensor_block);
  chartInstance.c2_is_active_c2_sensor_block = c2_g_y;
  sf_mex_destroy(&c2_u);
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2675654015U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1803981031U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2310581606U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4276244253U);
}
...
mxArray *sf_c2_sensor_block_get_autoinheritance_info(void)
{
...

  {
    ...
    pr[0] = (double)(3207863525U);
    pr[1] = (double)(4233035691U);
    pr[2] = (double)(219470114U);
    pr[3] = (double)(172993865U);
...
static mxArray *sf_get_sim_state_info_c2_sensor_block(void)
{
  ...
  char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[8],T\"delay\",},{M[1],M[12],T\"pck_success\",},{M[1],M[14],T\"pck_total\",},{M[1],M[11],T\"sensor_v\",},{M[1],M[13],T\"src_addr\",},{M[1],M[5],T\"timestamp\",},{M[8],M[0],T\"is_active_c2_sensor_block\",}}"
  };
...
static void mdlSetWorkWidths_c2_sensor_block(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    ...
    if (chartIsInlinable) {
      ...
      sf_mark_chart_reusable_outputs(S,"sensor_block","sensor_block",2,6);
    }
  ...
  ssSetChecksum0(S,(1379268619U));
  ssSetChecksum1(S,(1459841507U));
  ssSetChecksum2(S,(1608308346U));
  ssSetChecksum3(S,(3889567477U));
