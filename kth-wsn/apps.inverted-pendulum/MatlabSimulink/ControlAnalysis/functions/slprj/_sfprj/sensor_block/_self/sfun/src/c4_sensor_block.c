...
static SFc4_sensor_blockInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_sensor_block(void);
static void initialize_params_c4_sensor_block(void);
static void enable_c4_sensor_block(void);
static void disable_c4_sensor_block(void);
static void c4_update_debugger_state_c4_sensor_block(void);
static const mxArray *get_sim_state_c4_sensor_block(void);
static void set_sim_state_c4_sensor_block(const mxArray *c4_st);
static void finalize_c4_sensor_block(void);
static void sf_c4_sensor_block(void);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static void c4_eml_scalar_eg(void);
static real_T c4_sum(real_T c4_x[100]);
...
static void initialize_c4_sensor_block(void)
{
  ...
  chartInstance.c4_is_active_c4_sensor_block = 0U;
}
...
static const mxArray *get_sim_state_c4_sensor_block(void)
{
  ...
  c4_st = NULL;
  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_createcellarray(7));
  c4_u = *c4_errors;
  c4_b_y = NULL;
  ...
  for (c4_i0 = 0; c4_i0 < 100; c4_i0 = c4_i0 + 1) {
  ...
  if (!chartInstance.c4_errors_window_not_empty) {
    ...
    sf_mex_assign(&c4_d_y, sf_mex_create("y", &c4_c_u, 0, 0U, 1U, 0U, 1, 100));
  }
  ...
  for (c4_i1 = 0; c4_i1 < 100; c4_i1 = c4_i1 + 1) {
  ...
  if (!chartInstance.c4_pckTotalTrack_not_empty) {
    ...
    sf_mex_assign(&c4_f_y, sf_mex_create("y", &c4_e_u, 0, 0U, 1U, 0U, 1, 100));
  }

  sf_mex_setcell(c4_y, 4, c4_f_y);
  c4_f_u = chartInstance.c4_prevTotalPackets;
  c4_g_y = NULL;
  ...
  c4_g_u = chartInstance.c4_is_active_c4_sensor_block;
  c4_h_y = NULL;
...
static void set_sim_state_c4_sensor_block(const mxArray *c4_st)
{
  ...
  uint16_T c4_u0;
  uint16_T c4_f_y;
  const mxArray *c4_b_is_active_c4_sensor_block;
  uint8_T c4_u1;
  uint8_T c4_g_y;
  real_T *c4_c_errors;
  real_T *c4_reliability;
  ...
  *c4_reliability = c4_b_y;
  ...
  if (mxIsEmpty(c4_b_errors_window)) {
    ...
    sf_mex_import("errors_window", sf_mex_dup(c4_b_errors_window), &c4_dv0, 1, 0,
                  0U, 1, 0U, 1, 100);
    for (c4_i2 = 0; c4_i2 < 100; c4_i2 = c4_i2 + 1) {
      c4_c_y[c4_i2] = c4_dv0[c4_i2];
    }
  }

  sf_mex_destroy(&c4_b_errors_window);
  for (c4_i3 = 0; c4_i3 < 100; c4_i3 = c4_i3 + 1) {
  ...
  if (mxIsEmpty(c4_b_pckTotalTrack)) {
    ...
    sf_mex_import("pckTotalTrack", sf_mex_dup(c4_b_pckTotalTrack), &c4_dv1, 1, 0,
                  0U, 1, 0U, 1, 100);
    for (c4_i4 = 0; c4_i4 < 100; c4_i4 = c4_i4 + 1) {
      c4_e_y[c4_i4] = c4_dv1[c4_i4];
    }
  }

  sf_mex_destroy(&c4_b_pckTotalTrack);
  for (c4_i5 = 0; c4_i5 < 100; c4_i5 = c4_i5 + 1) {
    chartInstance.c4_pckTotalTrack[c4_i5] = c4_e_y[c4_i5];
  }

  c4_b_prevTotalPackets = sf_mex_dup(sf_mex_getcell(c4_u, 5));
  if (mxIsEmpty(c4_b_prevTotalPackets)) {
    chartInstance.c4_prevTotalPackets_not_empty = false;
  } else {
    chartInstance.c4_prevTotalPackets_not_empty = true;
    sf_mex_import("prevTotalPackets", sf_mex_dup(c4_b_prevTotalPackets), &c4_u0,
                  1, 5, 0U, 0, 0U, 0);
    c4_f_y = c4_u0;
  }

  sf_mex_destroy(&c4_b_prevTotalPackets);
  chartInstance.c4_prevTotalPackets = c4_f_y;
  c4_b_is_active_c4_sensor_block = sf_mex_dup(sf_mex_getcell(c4_u, 6));
  sf_mex_import("is_active_c4_sensor_block", sf_mex_dup
                (c4_b_is_active_c4_sensor_block), &c4_u1, 1, 3, 0U, 0, 0U, 0);
  c4_g_y = c4_u1;
  sf_mex_destroy(&c4_b_is_active_c4_sensor_block);
  chartInstance.c4_is_active_c4_sensor_block = c4_g_y;
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_sensor_block();
...
static void sf_c4_sensor_block(void)
{
  ...
  real_T *c4_b_update;
  c4_b_update = (real_T *)ssGetInputPortSignal(chartInstance.S, 0);
  ...
  _SFD_DATA_RANGE_CHECK(*c4_b_update, 0U);
  ...
  sf_debug_symbol_scope_add("prevTotalPackets",
    &chartInstance.c4_prevTotalPackets, c4_f_sf_marshall);
  ...
  sf_debug_symbol_scope_add("errors_window", &chartInstance.c4_errors_window,
    c4_d_sf_marshall);
  sf_debug_symbol_scope_add("item", &chartInstance.c4_item, c4_c_sf_marshall);
  sf_debug_symbol_scope_add("nargout", &c4_nargout, c4_sf_marshall);
  sf_debug_symbol_scope_add("nargin", &c4_nargin, c4_sf_marshall);
  sf_debug_symbol_scope_add("currentItem", &c4_currentItem, c4_sf_marshall);
  sf_debug_symbol_scope_add("SLIDING_WINDOW", &c4_SLIDING_WINDOW, c4_sf_marshall);
  sf_debug_symbol_scope_add("reliability", &c4_reliability, c4_sf_marshall);
  sf_debug_symbol_scope_add("errors", &c4_errors, c4_sf_marshall);
  ...
  _SFD_EML_CALL(0,15);
  if (CV_EML_IF(0, 1, c4_update == 1.0)) {
    _SFD_EML_CALL(0,16);
    ...
    c4_currentItem = c4_b_x - c4_d_x * 101.0;
    _SFD_EML_CALL(0,17);
    ...
    /*  to keep track of it. */
    _SFD_EML_CALL(0,22);
    if (CV_EML_COND(0, 0, (real_T)c4_pck_total == 0.0)) {
    } else if (CV_EML_COND(0, 1, !chartInstance.c4_prevTotalPackets_not_empty))
    {
    } else {
      CV_EML_MCDC(0, 0, false);
      CV_EML_IF(0, 3, false);
      _SFD_EML_CALL(0,26);
      c4_u2 = (uint32_T)c4_pck_total;
      c4_u3 = c4_u2 - (uint32_T)chartInstance.c4_prevTotalPackets;
      if (c4_u3 > c4_u2) {
        c4_u3 = 0U;
      }
    ...
    chartInstance.c4_pckTotalTrack[_SFD_EML_ARRAY_BOUNDS_CHECK("pckTotalTrack",
      (int32_T)_SFD_INTEGER_CHECK("currentItem",
      c4_currentItem), 1, 100, 1, 0) - 1] = 1.0;
    _SFD_EML_CALL(0,24);
   ...
   label_1:
    ...
    _SFD_EML_CALL(0,31);
    c4_u6 = (uint32_T)c4_pck_total;
    c4_u7 = c4_u6 - (uint32_T)c4_pck_success;
    if (c4_u7 > c4_u6) {
      c4_u7 = 0U;
    }
    ...
    if (c4_u8 > 65535U) {
      ...
      c4_u9 = (uint16_T)c4_u8;
    }

    if (CV_EML_IF(0, 4,
                  chartInstance.c4_errors_window[_SFD_EML_ARRAY_BOUNDS_CHECK(
          "errors_window", (int32_T)_SFD_INTEGER_CHECK("item",
           chartInstance.c4_item), 1, 100, 1, 0) - 1] < (real_T)c4_u9)) {
      _SFD_EML_CALL(0,32);
      c4_u10 = (uint32_T)c4_pck_total;
      c4_u11 = c4_u10 - (uint32_T)c4_pck_success;
      if (c4_u11 > c4_u10) {
        c4_u11 = 0U;
      }
      ...
      if (c4_u12 > 65535U) {
        ...
        c4_u13 = (uint16_T)c4_u12;
      }

      c4_d3 = (real_T)c4_u13 -
        chartInstance.c4_errors_window[_SFD_EML_ARRAY_BOUNDS_CHECK(
        "errors_window", (int32_T)_SFD_INTEGER_CHECK(
        "item", chartInstance.c4_item), 1, 100, 1, 0) - 1];
      c4_d4 = c4_d3;
      c4_d4 = c4_d4 < 0.0 ? muDoubleScalarCeil(c4_d4 - 0.5) :
        muDoubleScalarFloor(c4_d4 + 0.5);
      c4_d5 = c4_d4;
      if (c4_d5 < 65536.0) {
        if (c4_d5 >= 0.0) {
          c4_u14 = (uint16_T)c4_d5;
        } else {
          c4_u14 = 0U;
        }
      } else if (c4_d5 >= 65536.0) {
        c4_u14 = MAX_uint16_T;
      } else {
        c4_u14 = 0U;
      }
      ...
      chartInstance.c4_errors_window[_SFD_EML_ARRAY_BOUNDS_CHECK("errors_window",
        (int32_T)_SFD_INTEGER_CHECK("currentItem",
        c4_currentItem), 1, 100, 1, 0) - 1] = (real_T)c4_u14;
    } else {
      _SFD_EML_CALL(0,34);
      chartInstance.c4_errors_window[_SFD_EML_ARRAY_BOUNDS_CHECK("errors_window",
        (int32_T)_SFD_INTEGER_CHECK("currentItem",
        c4_currentItem), 1, 100, 1, 0) - 1] = 0.0;
    }
  ...
  c4_errors = chartInstance.c4_errors_window[_SFD_EML_ARRAY_BOUNDS_CHECK(
    "errors_window", (int32_T)_SFD_INTEGER_CHECK("item",
    chartInstance.c4_item), 1, 100, 1, 0) - 1];
  _SFD_EML_CALL(0,44);
  for (c4_i8 = 0; c4_i8 < 100; c4_i8 = c4_i8 + 1) {
    c4_dv2[c4_i8] = chartInstance.c4_errors_window[c4_i8];
  }

  c4_A = c4_sum(c4_dv2);
  for (c4_i9 = 0; c4_i9 < 100; c4_i9 = c4_i9 + 1) {
    c4_dv3[c4_i9] = chartInstance.c4_pckTotalTrack[c4_i9];
  }
...
static real_T c4_sum(real_T c4_x[100])
{
  ...
  for (c4_i10 = 0; c4_i10 < 100; c4_i10 = c4_i10 + 1) {
    c4_b_x[c4_i10] = c4_x[c4_i10];
  }

  c4_y = c4_b_x[0];
  for (c4_k = 2.0; c4_k <= 100.0; c4_k = c4_k + 1.0) {
    c4_b_k = c4_k;
    c4_y = c4_y + c4_b_x[_SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)
      _SFD_INTEGER_CHECK("k", c4_b_k), 1, 100, 1, 0) - 1];
  }
...
static void c4_eml_warning(void)
{
  ...
  char_T c4_b_u[19];
  const mxArray *c4_b_y = NULL;
  for (c4_i11 = 0; c4_i11 < 15; c4_i11 = c4_i11 + 1) {
    c4_u[c4_i11] = c4_cv0[c4_i11];
  }

  c4_y = NULL;
  sf_mex_assign(&c4_y, sf_mex_create("y", &c4_u, 10, 0U, 1U, 0U, 2, 1, 15));
  for (c4_i12 = 0; c4_i12 < 19; c4_i12 = c4_i12 + 1) {
    c4_b_u[c4_i12] = c4_cv1[c4_i12];
  }
...
static const mxArray *c4_d_sf_marshall(void *c4_chartInstance, void *c4_u)
{
  ...
  const mxArray *c4_b_y = NULL;
  c4_y = NULL;
  for (c4_i13 = 0; c4_i13 < 100; c4_i13 = c4_i13 + 1) {
    c4_b_u[c4_i13] = (*((real_T (*)[100])c4_u))[c4_i13];
  }
  ...
  if (!chartInstance.c4_errors_window_not_empty) {
    ...
    sf_mex_assign(&c4_b_y, sf_mex_create("y", &c4_b_u, 0, 0U, 1U, 0U, 1, 100));
  }
...
static const mxArray *c4_e_sf_marshall(void *c4_chartInstance, void *c4_u)
{
  ...
  const mxArray *c4_b_y = NULL;
  c4_y = NULL;
  for (c4_i14 = 0; c4_i14 < 100; c4_i14 = c4_i14 + 1) {
    c4_b_u[c4_i14] = (*((real_T (*)[100])c4_u))[c4_i14];
  }
...
const mxArray *sf_c4_sensor_block_get_eml_resolved_functions_info(void)
{
  ...
  for (c4_i15 = 0; c4_i15 < 48; c4_i15 = c4_i15 + 1) {
    ...
    sf_mex_addfield(c4_m0, sf_mex_create("nameCaptureInfo", c4_r0->dominantType,
      15, 0U, 0U, 0U, 2, 1, strlen(c4_r0->dominantType)),
                    "dominantType", "nameCaptureInfo", c4_i15);
    ...
    sf_mex_addfield(c4_m0, sf_mex_create("nameCaptureInfo", &c4_r0->fileTime1, 7,
      0U, 0U, 0U, 0), "fileTime1", "nameCaptureInfo", c4_i15
                    );
    sf_mex_addfield(c4_m0, sf_mex_create("nameCaptureInfo", &c4_r0->fileTime2, 7,
      0U, 0U, 0U, 0), "fileTime2", "nameCaptureInfo", c4_i15
                    );
  }
...
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[48])
{
  ...
  c4_info[3].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m";
  c4_info[3].fileLength = 960U;
  c4_info[3].fileTime1 = 1228115389U;
  c4_info[3].fileTime2 = 0U;
  c4_info[4].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elfun/mod.m";
  ...
  c4_info[6].name = "isreal";
  c4_info[6].dominantType = "double";
  c4_info[6].resolved = "[B]isreal";
  ...
  c4_info[8].name = "class";
  c4_info[8].dominantType = "double";
  c4_info[8].resolved = "[B]class";
  ...
  c4_info[27].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c4_info[27].fileLength = 1337U;
  c4_info[27].fileTime1 = 1228115399U;
  c4_info[27].fileTime2 = 0U;
  c4_info[28].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c4_info[28].name = "eml_is_float_class";
  c4_info[28].dominantType = "char";
  c4_info[28].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c4_info[28].fileLength = 226U;
  c4_info[28].fileTime1 = 1197872041U;
  c4_info[28].fileTime2 = 0U;
  c4_info[29].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_is_float_class.m";
  c4_info[29].name = "strcmp";
  c4_info[29].dominantType = "char";
  c4_info[29].resolved = "[B]strcmp";
  c4_info[29].fileLength = 0U;
  c4_info[29].fileTime1 = 0U;
  c4_info[29].fileTime2 = 0U;
  c4_info[30].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/eps.m";
  c4_info[30].name = "uminus";
  c4_info[30].dominantType = "double";
  c4_info[30].resolved = "[B]uminus";
  ...
  c4_info[31].resolved = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[31].fileLength = 3302U;
  c4_info[31].fileTime1 = 1242772494U;
  c4_info[31].fileTime2 = 0U;
  c4_info[32].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/ops/mtimes.m";
  c4_info[32].name = "size";
  c4_info[32].dominantType = "double";
  c4_info[32].resolved = "[B]size";
  ...
  c4_info[34].fileLength = 3965U;
  c4_info[34].fileTime1 = 1240283566U;
  c4_info[34].fileTime2 = 0U;
  c4_info[35].context = "[ILX]$matlabroot$/toolbox/eml/lib/matlab/datafun/sum.m";
  c4_info[35].name = "isequal";
  c4_info[35].dominantType = "double";
  c4_info[35].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c4_info[35].fileLength = 180U;
  c4_info[35].fileTime1 = 1226598871U;
  c4_info[35].fileTime2 = 0U;
  c4_info[36].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/elmat/isequal.m";
  c4_info[36].name = "eml_isequal_core";
  c4_info[36].dominantType = "double";
  c4_info[36].resolved =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c4_info[36].fileLength = 3981U;
  c4_info[36].fileTime1 = 1236278872U;
  c4_info[36].fileTime2 = 0U;
  c4_info[37].context =
    "[ILX]$matlabroot$/toolbox/eml/lib/matlab/eml/eml_isequal_core.m";
  c4_info[37].name = "ge";
  c4_info[37].dominantType = "double";
  c4_info[37].resolved = "[B]ge";
  ...
  c4_info[39].name = "ndims";
  c4_info[39].dominantType = "double";
  c4_info[39].resolved = "[B]ndims";
...
/* SFunction Glue Code */
void sf_c4_sensor_block_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2381288890U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4199793026U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1328653093U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2613221036U);
}

mxArray *sf_c4_sensor_block_get_autoinheritance_info(void)
{
...
static mxArray *sf_get_sim_state_info_c4_sensor_block(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[10],T\"errors\",},{M[1],M[11],T\"reliability\",},{M[4],M[0],T\"errors_window\",S'l','i','p'{{M1x2[110 123],M[0],}}},{M[4],M[0],T\"item\",S'l','i','p'{{M1x2[124 128],M[0],}}},{M[4],M[0],T\"pckTotalTrack\",S'l','i','p'{{M1x2[129 142],M[0],}}},{M[4],M[0],T\"prevTotalPackets\",S'l','i','p'{{M1x2[143 159],M[0],}}},{M[8],M[0],T\"is_active_c4_sensor_block\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_sensor_block_get_check_sum(&mxChecksum);
      ...
      /* do this only if simulation is starting */
      {
        ...
        if (chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(4,2,0,1,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,
                              "reliability",0,(MexFcnForType)c4_sf_marshall);
...

        {
          ...
          real_T *c4_errors;
          real_T *c4_reliability;
          c4_update = (real_T *)ssGetInputPortSignal(chartInstance.S, 0);
          c4_errors = (real_T *)ssGetOutputPortSignal(chartInstance.S, 1);
...
static void sf_opaque_initialize_c4_sensor_block(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S,0);
  initialize_params_c4_sensor_block();
  initialize_c4_sensor_block();
}

static void sf_opaque_enable_c4_sensor_block(void *chartInstanceVar)
{
  enable_c4_sensor_block();
}

static void sf_opaque_disable_c4_sensor_block(void *chartInstanceVar)
{
  disable_c4_sensor_block();
}

static void sf_opaque_gateway_c4_sensor_block(void *chartInstanceVar)
{
  sf_c4_sensor_block();
}

static mxArray* sf_opaque_get_sim_state_c4_sensor_block(void *chartInstanceVar)
{
  mxArray *st = (mxArray *) get_sim_state_c4_sensor_block();
  return st;
}

static void sf_opaque_set_sim_state_c4_sensor_block(void *chartInstanceVar,
  const mxArray *st)
{
  set_sim_state_c4_sensor_block(sf_mex_dup(st));
}

static void sf_opaque_terminate_c4_sensor_block(void *chartInstanceVar)
{
  ...
  finalize_c4_sensor_block();
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_sensor_block(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_sensor_block(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("sensor_block","sensor_block",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetRTWCG(S,sf_rtw_info_uint_prop("sensor_block","sensor_block",4,"RTWCG"));
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("sensor_block",
      "sensor_block",4,"gatewayCannotBeInlinedMultipleTimes"));
    if (chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"sensor_block","sensor_block",4,3);
      sf_mark_chart_reusable_outputs(S,"sensor_block","sensor_block",4,2);
    }

    sf_set_rtw_dwork_info(S,"sensor_block","sensor_block",4);
...
static void mdlRTW_c4_sensor_block(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "sensor_block", "sensor_block",4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void mdlStart_c4_sensor_block(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway = sf_opaque_gateway_c4_sensor_block;
  chartInstance.chartInfo.initializeChart = sf_opaque_initialize_c4_sensor_block;
  chartInstance.chartInfo.terminateChart = sf_opaque_terminate_c4_sensor_block;
  chartInstance.chartInfo.enableChart = sf_opaque_enable_c4_sensor_block;
  chartInstance.chartInfo.disableChart = sf_opaque_disable_c4_sensor_block;
  chartInstance.chartInfo.getSimState = sf_opaque_get_sim_state_c4_sensor_block;
  chartInstance.chartInfo.setSimState = sf_opaque_set_sim_state_c4_sensor_block;
  chartInstance.chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_sensor_block;
  chartInstance.chartInfo.zeroCrossings = NULL;
  chartInstance.chartInfo.outputs = NULL;
  chartInstance.chartInfo.derivatives = NULL;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c4_sensor_block;
  chartInstance.chartInfo.mdlStart = mdlStart_c4_sensor_block;
  chartInstance.chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c4_sensor_block;
...
void c4_sensor_block_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_sensor_block(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_sensor_block(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_sensor_block(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_sensor_block_method_dispatcher.\n"
