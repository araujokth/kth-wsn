...
% From TKN154_MAC.h
WTSelf.IEEE154_aNumSuperframeSlots = 32;            % We expand the superframe to 20 slots
WTSelf.capSlots = 0;                                % One of them is for the CAP
WTSelf.cfpSlots = 22;
...
WTSelf.lvm = zeros(10, 6, WTSelf.nWaterTanks);
...
WTModeling.STEADY_STATE_TIME = [300 600 900 ; 0 0 0];
